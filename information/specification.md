...
[Random-Improve](#random-improve) algorithm, as [experimental
evidence](#self-organization-in-coin-selection) shows that it performs better
at [minimising dust](#goals) and maintaining a UTxO set with [useful
outputs](#goals).
